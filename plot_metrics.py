...
METRICS_FILE = os.path.join(PROJECT_DIR, "results", "hf", "hf_metrics.json")
OUTPUT = os.path.join(PROJECT_DIR, "results", "hf", "hf_metrics_plot.png")
...
plt.title("Evaluation Metrics (HF LoRA)")
plt.ylabel("Score")
plt.tight_layout()
plt.savefig(OUTPUT)
